...
//YouTube: @OTM_Rocky
//WhatsApp:  https://wa.me/message/ZQFC4YAEOSM2B1
...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By Rocky .... Bot Owner ${ownername}  `).catch(_ => _)
        }
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://telegra.ph/file/cbf3858a08efefa2d1d47.jpg',
...
break
            case 'afk':
                ...
                break
case 'song':
xeonimun('*Error!* _Download Commands are not available for this Bot_')
break
case 'video':
xeonimun('*Error!* _Download Commands are not available for this Bot_')
break
...
break
case 'rocky':
xeonimun('*Send me a message for status view"🙇🏻‍♀️❤️🖇️* \n \n 🖇️ _https://wa.me/message/ZQFC4YAEOSM2B1_ \n⭕ *Name* - Rocky💖🧚‍♀️🪄 \n⭕ *From*  - Anuradhapura  🥰💖🏡    \n⭕ *Age* - 18(2006)👀🤍🎂🪄 \n⭕ *Boy* 🐣💫 \n 😘❤️\n 🖇️ _http://www.tiktok.com/@alone_sithu28_ \n ')
break
case 'hey_rocky':
xeonimun('*Ｆᴏʀ ＳᴛΔᵀᴜs Ｖɪᴠᴇs "🙇🏻‍♀️❤️🖇️* \n⭕ *Name* - Rocky💖🧚‍♀️🪄 \n⭕ *From*  - Anuradhapura  🥰💖🏡    \n⭕ *Age* - 18(2006)👀🤍🎂🪄 \n⭕ *Boy* 🐣💫 \n 😘❤️\n 🖇️ _http://www.tiktok.com/@alone_sithu28_ \n \n 🖇️ _https://wa.me/message/ZQFC4YAEOSM2B1_  ')
     break           
case 'alive':
xeonimun(' *Hey,I am Online Now.*👨🏻‍💻 \n \n 🖇️ _https://wa.me/message/ZQFC4YAEOSM2B1_ \n \n 🖇️ _https://whatsapp.com/channel/0029VaqAxZ435fLnLIBAY33c_ ')
break
case 'ping':
xeonimun(' *Ping 10MS*👨🏻‍💻   \n _https://wa.me/message/ZQFC4YAEOSM2B1_ \n \n _https://whatsapp.com/channel/0029VaqAxZ435fLnLIBAY33c_ ')
break
            case 'menu':
            case 'botek':
            case 'price':
